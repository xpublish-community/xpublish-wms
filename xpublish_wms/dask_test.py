...
def loaddata():
    ...
    ds = dask_connect.load_data_s3('s3://nextgen-dmac/nos/nos.dbofs.fields.f048.20230423.t00z.nc.zarr', options)    	
...
def getmap(ds):
    ...
    # GFS calls
    query_params = "service=WMS&version=1.3.0&request=GetMap&layers=temp&crs=EPSG:3857&bbox=-5009377.085697312,0,0,5009377.085697312&width=512&height=512&styles=raster/default&colorscalerange=0,10&time=2023-04-23T00:00:00Z"
