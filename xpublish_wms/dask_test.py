...
def getmap(ds):
    ...
    # GFS calls
    query_params = "service=WMS&version=1.3.0&request=GetMap&layers=swh&crs=EPSG:3857&bbox=-5009377.085697312,0,0,5009377.085697312&width=512&height=512&styles=raster/default&colorscalerange=0,10&time=2022-10-29T05:00:00Z"
